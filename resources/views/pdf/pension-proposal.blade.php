...
<head>
    ...
    <style>
        ...
        * {
        ...
        .header {
            border-bottom: 2px solid #2f6f67;
            padding-bottom: 13px;
            margin-bottom: 14px;
        }
...
<div class="header">
    ...
    <table class="meta">
        <tr>
            <td><span class="meta-label">Cliente</span><br><span
                    class="meta-value">{{ $proposal->client['full_name'] }}</span></td>
            <td><span class="meta-label">NSS</span><br><span class="meta-value">{{ $proposal->client['nss'] }}</span>
            </td>
            <td><span class="meta-label">Fecha de elaboración</span><br><span
                    class="meta-value">{{ $proposal->generatedAt->format('d/m/Y') }}</span></td>
        </tr>
    </table>
</div>
...
<div class="section">
    ...
    <div class="card">
        <table class="grid">
            <tr>
                <td><span class="field-label">Nombre</span><span
                        class="field-value">{{ $proposal->client['full_name'] }}</span></td>
                <td><span class="field-label">CURP</span><span
                        class="field-value">{{ $proposal->client['curp'] }}</span></td>
                <td><span class="field-label">NSS</span><span class="field-value">{{ $proposal->client['nss'] }}</span>
                </td>
            </tr>
            <tr>
                <td><span class="field-label">Fecha de nacimiento</span><span
                        class="field-value">{{ $proposal->client['birthdate']->format('d/m/Y') }}</span></td>
                <td><span class="field-label">Edad</span><span class="field-value">{{ $proposal->client['age'] }}</span>
                </td>
                <td><span class="field-label">Estado civil</span><span
                        class="field-value">{{ $proposal->client['marital_status'] }}</span></td>
            </tr>
            <tr>
                <td><span class="field-label">Hijos menores o estudiantes</span><span
                        class="field-value">{{ $proposal->client['children'] }}</span></td>
                <td><span class="field-label">Padres registrados</span><span
                        class="field-value">{{ $proposal->client['parents'] ?? 'No disponible' }}</span></td>
                <td></td>
            </tr>
        </table>
    </div>
...
<div class="section">
    ...
    <table class="data-table">
        <tr>
            <td>Semanas cotizadas alcanzadas</td>
            <td>{{ number_format($proposal->pensionScenario['contributed_weeks'], 2) }}</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>{{ $proposal->pensionScenario['first_deposit_age'] }}</td>
        </tr>
        <tr>
            <td>Fecha estimada de inicio del trámite</td>
            <td>{{ $proposal->pensionScenario['process_start_date']->format('d/m/Y') }}</td>
        </tr>
        <tr>
...
<div class="footer">Documento informativo. Los importes deberán validarse al formalizar el proyecto y la solicitud de
    pensión.
</div>
</body>
</html>
